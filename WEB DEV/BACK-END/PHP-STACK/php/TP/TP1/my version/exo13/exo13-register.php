...
if (isset($_POST['register'])) {
	...
	try {
		$sql = "INSERT INTO utilisateur (nom,prenom,telephone,email,genre,pass,role)value(:nom,:prenom,:telephone,:email,:genre,:pass,:role)";
		...
		if ($e->getCode() == 23000) {
			$erreur = "Adresse email exist deja!";
		}
	}
}
